...
Matches the LLMInterface(Protocol) expected by SovereignNEXT operators:
...
class CloudLLMBase(ABC):
    ...
    Satisfies the LLMInterface Protocol used by:
      - SovereignNEXT.operators.become_expander
      - SovereignNEXT.operators.tension_detector
      - SovereignNEXT.operators.collapse_operator
      - SovereignNEXT.operators.claim_extractor
    """
